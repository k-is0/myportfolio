...
export const projects: Project[] = [
  {
    ...
    descriptor:
      "A resonant acoustic field that sorts microplastics out of contaminated water streams — without filters.",
    ...
    body: [
      ...
      {
        kind: "para",
        text: "The MATLAB side models particle migration under the standing-wave pressure field to predict separation efficiency across particle sizes, and to pick a transducer frequency before committing to hardware. The physical side is where it gets honest: pump clogs on the RS Online M400 cleared with inline filtration, and a transducer impedance mismatch that was quietly killing signal power transfer until it wasn't.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        kind: "para",
        text: "Most of the work sat in the audio chain — microphone capture, digital processing, cellular transmission, speaker output — configuring the onboard audio codec, cellular module, and system clocking to deliver clean voice calls end-to-end. Real-time signal processing included an adaptive filter for acoustic echo cancellation running on a resource-constrained microcontroller; call quality was then validated on live hardware, and power-delivery failures on the cellular module were traced to component-level root cause.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      {
        kind: "para",
        text: "The mission profile is the interesting part. Emergency medical response for an electric VTOL cuts across every phase the aircraft is bad at — vertical take-off into forward transition, cruise over an unfamiliar route, hover at a constrained landing site — and each phase costs energy and time differently.",
      },
      {
        kind: "para",
  ...
  },
  {
    ...
    body: [
      ...
      {
        kind: "para",
        text: "The midsole is a functionally graded lattice — denser at the heel, opener through the arch, medium at the ball — grading driven by the pressure map of a walking gait. It prints overnight in a single piece. The rest of the work is the boring, necessary side of DfAM: which face lies on the build plate, how many pairs fit in a job, how the strap survives de-caking.",
      },
    ],
  },
  {
    ...
    descriptor:
      "A five-year independent teaching practice — 25+ students, built on referrals, handed on at graduation.",
    role: "Founder",
    ...
    body: [
      {
        kind: "para",
        text: "Started in sixth form, ran through university. Twenty-five-plus students across five years, £5,000+ in revenue, a client base built entirely on referrals and community networks. Lessons were pitched per-student — beginners and children at first, later expanding to adult and elderly learners — breaking classical technique into pieces that actually fit the pace and the physical ability of whoever was sitting at the keyboard.",
      },
      {
        kind: "para",
        text: "The pandemic killed in-person overnight, so the whole practice moved online — lesson delivery re-engineered around video, remote practice feedback, the slower feedback loops that came with that. On graduation, the practice was handed over to a successor; it still operates in Bath today.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      {
        kind: "para",
        text: "Seven years of structured Shaolin training, spread across London and Beijing. Competed and performed publicly at age fourteen — Chinatown in Soho and at the O2 in Canary Wharf.",
      },
      {
        kind: "para",
  ...
  },
  {
    ...
    body: [
      {
        kind: "para",
        text: "Two years on committee — Social Secretary in the first year, Events Manager in the second — for a society of around fifty active members and a hundred-plus registered. Fifteen fully booked-out events over that run: socials, workshops, performance nights.",
      },
      {
        kind: "para",
        text: "The interesting part was the logistics layer behind it — budgets, venue bookings, vendor coordination, cash flow over £1,000 — delivered on the kind of deadlines you can't renegotiate once the tickets are sold.",
      },
    ],
  },
];
